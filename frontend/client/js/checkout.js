...
function renderOrder() {
  ...
  itemsContainer.innerHTML = currentOrderDetails.orderDetails
    .map(
      (item) => `
  ...
  if (appliedVoucher) {
    ...
    document.getElementById("order-discount-display").textContent =
      "-" + formatCurrency(discountAmt);
  } else {
    document.getElementById("discount-row").classList.add("hidden");
  }

  document.getElementById("order-status-display").textContent =
