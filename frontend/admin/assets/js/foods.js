    ...
    return `
      <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
        <td class="px-6 py-4 whitespace-nowrap">
          <img src="${window.AdminApp.escapeHtml(window.AdminApp.getImageUrl(food.imageUrl))}" alt="${window.AdminApp.escapeHtml(food.name)}" class="h-12 w-12 rounded-lg object-cover border border-slate-200 dark:border-slate-700" onerror="this.src='https://placehold.co/600x400?text=No+Image'">
        </td>
        <td class="px-6 py-4">
